...
SermonConfig sermonConfigFromJson(String str) => SermonConfig.fromJson(json.decode(str));
...
class Files {
    ...
    factory Files.fromJson(Map<String, dynamic> json) => Files(
        ...
        progressive: List<Progressive>.from(json["progressive"].map((x) => Progressive.fromJson(x))),
    );
...
class Dash {
    ...
    factory Dash.fromJson(Map<String, dynamic> json) => Dash(
        ...
        streamsAvc: List<Stream>.from(json["streams_avc"].map((x) => Stream.fromJson(x))),
